...
A single-file, browser-based tool to build GitHub READMEs visually.  
Drag blocks, edit inline, preview in real-time, export as `.md`.
...
1. Click a block in the sidebar to add it
